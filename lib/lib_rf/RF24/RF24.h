...
public:
     ...
     *
     * Creates a new instance of this driver.  Before using, you create an instance.
     * If you use this constructor you MUST assign the pins - that this chip is connected to - in the begin function. 
     *
     */
    RF24(void);
    ...
    /**
     * Begin operation of the chip 
     * Use this method if your constructor does not assign the pins!
     *
     * Call this in setup(), before calling any other methods.
     * @code radio.begin(cepin, cspin) @endcode
     */
